...
<!-- saved from url=(0084)https://uai2.createsend.com/t/ViewEmailInIFrame/t/968AF676E7D69962/C67FD2F38AC4859C/ -->
    ...
    <tbody><tr>
      <td style="padding: 0;vertical-align: top">
        <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
          <tbody><tr>
            <td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: Georgia,serif">Modulo de Seguridad.</td>
              ...
              <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                <tbody><tr>
                  <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                    ...
                    <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 44px">Generación de clave</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Se ha generado una nueva clave para el usuario: <strong style="font-weight: bold">${usuario.nombreUsuario} </strong>.</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Los datos de inicio de sesión son los siguientes:</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px;text-align: center"><br>
                    <strong style="font-weight: bold">Usuario:&nbsp;</strong>${usuario.idUsuario}</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px;text-align: center"><strong style="font-weight: bold">Password:&nbsp;</strong>${usuario.claveUsuario}</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px;text-align: left">Para cambiar dichos datos, dirigase a la sección de Cuenta dentro de su barra de navegación y siga los pasos para la modificacion.</p>
              ...
              <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                <tbody><tr>
                  <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                    ...
                    <h3 style="Margin-top: 0;color: #555;font-weight: normal;font-size: 18px;line-height: 26px;Margin-bottom: 24px;font-family: Georgia,serif;text-align: right">Muchas gracias.</h3>
                ...
                <tbody><tr>
                  <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                    ...
                    <div>
                      ...
                      <span class="block"><a style="font-weight: bold;text-decoration: none;transition: all .2s;color: #999" href="http://uai.createsend1.com/t/t-u-tindut-l-y/" target="_blank">Desuscribirse</a></span>
                    </div>
                  </td>
                </tr>
                </tbody></table>
...
<img style="border: 0 !important;-ms-interpolation-mode: bicubic;height: 1px !important;width: 1px !important;margin: 0 !important;padding: 0 !important" src="./mail_files/o.gif" width="1" height="1" border="0" alt="">
<script type="text/javascript" src="./mail_files/jquery-1.7.2.min.js"></script><script type="text/javascript">$(function(){$('area,a').attr('target', '_blank');});</script>
</body></html>
